        ...
        <Box  mt={3}>  
            ...
            >
              ...
              <Box p={2}>
               ...
               <Button onClick={handleEdit} variant="contained" style={{backgroundColor: "#4a47a3", color:"white"}}>Edit</Button>
               <Button onClick={handleClickOpen} variant="contained" style={{backgroundColor: "#e40017", color:"white"}}>Delete</Button>
                </Grid>
              </Box>
           {/* Dialog */}
            <div>
